  ...
  return (
    <div className="rounded-xl border border-[#222222] bg-[#121212] px-3 py-1.5 space-y-1.5 select-none text-xs">
      ...
      <div className="relative flex items-center group/carousel">
        ...
        >
          {devices.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-3 text-zinc-500 w-full text-xs font-mono gap-1.5 border border-dashed border-[#262626] rounded-lg">
              ...
              <button
                onClick={handleOpenAdd}
                className="px-2 py-0.5 bg-[#3B82F6] hover:bg-blue-600 text-white rounded text-[9px] font-medium font-sans flex items-center gap-1 transition-colors"
              >
