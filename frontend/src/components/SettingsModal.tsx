...
import { CameraDevice, S3Config, SambaConfig, StorageLocationInfo } from '../types';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'hardware' | 'storage' | 's3' | 'samba' | 'security'>('hardware');
